...
[Improve generic rule](https://github.com/gitleaks/gitleaks/issues/1052)
[Add rule to detect password in 
URL](https://gitlab.com/gitlab-org/security-products/analyzers/secrets/-/blob/master/gitleaks.toml#L235)
